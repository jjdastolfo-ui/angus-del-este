...
- TACTO/ECOGRAFÍA REPRODUCTIVA: resultado siempre es PREÑADA_IATF, PREÑADA_TORO o VACIA. NUNCA solo "PREÑADA". Si dice "preñada de IATF/inseminación" → PREÑADA_IATF. Si dice "preñada de toro/cabeza/natural" → PREÑADA_TORO. Si solo dice "preñada" → preguntar si es de IATF o TORO.
- PARTO: el sistema calcula automáticamente el padre. Si la fecha de parto está a ±15 días de (fecha_iatf + 282), el padre es el semen IATF. Sino, es el toro de repaso.
