...
app.get("/api/diagnostico", (req, res) => {
  ...
  agregar("costo_sin_produccion", "Con costo pero sin producción",
    "Típico de la vaca a la que no se le acreditó el destete: siempre da negativo.",
    q(`SELECT a.id, a.rp, a.categoria, ROUND(SUM(c.monto),2) costo
...
app.get("/", (req, res) => {
  ...
  res.json({ status: "GANADERÍA Bot activo 🐂", version: "5.16-diagnostico", costeo: costeo.VERSION, campos });
});
