...
function motor(db) {
  ...
  function reabrirPorDestete(o) {
    ...
    for (const a of candidatos) {
      ...
      /* Si ya llegó a plantel o intermedia, su valor lo manda el hito
         reproductivo: reabrir por destete le borraría la historia buena. */
      const et = etapaActual(a.id);
      if (["INTERMEDIA", "PLANTEL", "FIN"].includes(et)) { res.en_plantel++; continue; }
